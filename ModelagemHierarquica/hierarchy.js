 ...
 /** @type {Matrix4} */
 var rightThighMatrix = new Matrix4().setTranslate(2, -6, 0);
 /** @type {Matrix4} */
 var leftThighMatrix = new Matrix4().setTranslate(-2, -6, 0);
 /** @type {Matrix4} */
 var rightFootMatrix = new Matrix4().setTranslate(0, -6, 1);
 /** @type {Matrix4} */
 var leftFootMatrix = new Matrix4().setTranslate(0, -6, 1);
 var torsoAngle = 0.0;
 ...
 var thighMatrixLocal = new Matrix4().setScale(3, 12, 2);
   ...
   switch (ch) {
    ...
    case "w":
      ...
      var currentThigh = new Matrix4()
        ...
        .translate(0, -2.5, -1.0);
      rightThighMatrix.setTranslate(2, -6, 0).multiply(currentThigh);
      break;
    case "W":
      rightThighAngle -= 15;
      var currentThigh = new Matrix4()
    ...
    case "q":
      ...
      var currentThigh = new Matrix4()
        ...
        .translate(0, -2.5, -1.0);
      leftThighMatrix.setTranslate(-2, -6, 0).multiply(currentThigh);
      break;
    case "Q":
      leftThighAngle -= 15;
      var currentThigh = new Matrix4()
    ...
    case "o":
      leftFootAngle += 15;
      leftFootMatrix.setTranslate(0, -6, 1).rotate(leftFootAngle, 0, 1, 0);
      break;
    case "O":
      leftFootAngle -= 15;
      leftFootMatrix.setTranslate(0, -6, 1).rotate(leftFootAngle, 0, 1, 0);
    ...
    case "p":
      rightFootAngle += 15;
      rightFootMatrix.setTranslate(0, -6, 1).rotate(rightFootAngle, 0, 1, 0);
      break;
    case "P":
      rightFootAngle -= 15;
      rightFootMatrix.setTranslate(0, -6, 1).rotate(rightFootAngle, 0, 1, 0);
 ...
 function renderCube(matrixStack, matrixLocal) {
   ...
   gl.uniform4f(loc, 1.0, 0.4, 0.4, 1.0);
   var loc = gl.getUniformLocation(lightingShader, "lightPosition");
   gl.uniform4f(loc, 5.0, 10.0, 5.0, 1.0);
   var modelMatrixloc = gl.getUniformLocation(lightingShader, "model");
   normalMatrixLoc = gl.getUniformLocation(lightingShader, "normalMatrix");
   uModelView = gl.getUniformLocation(lightingShader, "modelview");
